        ...
        area(Content)
        {
            ...
            group(Step1)
            {
                ...
                group("Let's go!")
                {
                    ...
                    {
                        ShowCaption = false;
                        InstructionalText = 'On the next page you will be asked to setup the required settings, before you can use the solution.';
                    }
                }
            }
            ...
            {
                ShowCaption = false;
                InstructionalText = 'Select the No. Series that you wan''t assign to your assignments.';
            ...
            group(Step3)
            {
                ...
                {
                    ShowCaption = false;
                    InstructionalText = 'Congratulations you have completed the setup wizard.';
                ...
                {
                    ShowCaption = false;
                    InstructionalText = 'Would you like to import the todos from the Jsonplaceholder API?';
